...
import { ListarProdutosComponent } from './components/produtos/listar-produtos/listar-produtos.component'; // ADICIONE ESTA LINHA
...
export const routes: Routes = [
    ...
    { path: 'produtos/listar-produtos', component: ListarProdutosComponent } // NOVA ROTA
];